            ...
            <div class="home-card rounded-3xl border border-slate-200 bg-white p-7 dark:border-slate-800 dark:bg-slate-900">
                ...
                <div class="mt-6 space-y-4 rounded-2xl border border-slate-200 bg-slate-50 p-5 dark:border-slate-800 dark:bg-slate-950">
                    ...
                    <div class="grid grid-cols-2 gap-x-6 gap-y-4">
                        <div class="min-w-0"><div class="mb-2 flex items-center justify-between gap-2 text-xs"><span class="truncate text-slate-500">Satisfaction</span><span class="shrink-0 font-semibold text-slate-800 dark:text-slate-200">87%</span></div><x-bladewind::progress-bar percentage="87" color="green" /></div>
                        <div class="min-w-0"><div class="mb-2 flex items-center justify-between gap-2 text-xs"><span class="truncate text-slate-500">Uptime</span><span class="shrink-0 font-semibold text-slate-800 dark:text-slate-200">99%</span></div><x-bladewind::progress-bar percentage="99" color="violet" /></div>
                        <div class="min-w-0"><div class="mb-2 flex items-center justify-between gap-2 text-xs"><span class="truncate text-slate-500">Adoption</span><span class="shrink-0 font-semibold text-slate-800 dark:text-slate-200">64%</span></div><x-bladewind::progress-bar percentage="64" color="cyan" /></div>
                        <div class="min-w-0"><div class="mb-2 flex items-center justify-between gap-2 text-xs"><span class="truncate text-slate-500">Churn risk</span><span class="shrink-0 font-semibold text-slate-800 dark:text-slate-200">18%</span></div><x-bladewind::progress-bar percentage="18" color="pink" /></div>
                    </div>
                </div>
